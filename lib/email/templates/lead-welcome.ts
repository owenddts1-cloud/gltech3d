...
export function buildLeadWelcomeEmail(opts: LeadWelcomeOptions): {
  ...
  // Duas saudações: a de HTML escapa o nome, a de texto puro NÃO. Reusar a versão escapada
  // no corpo text/plain faz um lead "O'Brien" receber "Olá, O&#39;Brien!".
...
<body style="margin:0;padding:0;background:#f9f7f2;font-family:system-ui,-apple-system,Segoe UI,sans-serif;color:#2d241e">
  <div style="max-width:560px;margin:0 auto;padding:32px 24px">
    ...
    <h1 style="font-size:22px;line-height:1.3;margin:16px 0 8px;color:#2d241e">${hiHtml}</h1>
