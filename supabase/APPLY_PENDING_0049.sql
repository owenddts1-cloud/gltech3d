-- =============================================================================
-- APLICAR PENDÊNCIA — migration 0049_model_folders
-- =============================================================================
-- Cole INTEIRO no Supabase SQL Editor e clique em "Run". Idempotente, numa transação.
-- =============================================================================
...
-- CONFERÊNCIA:
--   select relrowsecurity from pg_class where relname='model_folders';  -- t
--   select count(*) from information_schema.columns where table_name='models_3d'
--     and column_name in ('folder_id','kind','mime_type','sort_order');  -- 4
