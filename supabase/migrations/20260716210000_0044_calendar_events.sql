-- 0044_calendar_events
-- Eventos personalizados do Calendário saindo do localStorage para o banco.
-- Antes viviam em localStorage["gltech_calendar_events"] — não eram
-- multi-dispositivo nem multi-usuário, inúteis para uma equipe.
--
-- Só os eventos CRIADOS no calendário moram aqui. Os eventos derivados de OS
-- (type 'os') continuam calculados on-demand a partir de service_orders — não
-- se duplica o que já é fonte de verdade (doutrina DIRC).
--
