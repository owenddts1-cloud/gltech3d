-- =============================================================================
-- APLICAR PENDÊNCIA — migration 0045_models_3d
-- =============================================================================
...
-- CONFERÊNCIA (após o commit):
--   select relrowsecurity from pg_class where relname = 'models_3d';           -- t
--   select id, public from storage.buckets where id = 'models-3d';            -- models-3d | f
--   select count(*) from pg_policies where tablename='objects' and policyname like '%models_3d%'; -- 3
