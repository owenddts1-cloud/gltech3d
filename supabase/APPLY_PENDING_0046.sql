-- =============================================================================
-- APLICAR PENDÊNCIA — migration 0046_avatars_bucket
-- =============================================================================
...
-- CONFERÊNCIA:
--   select id, public from storage.buckets where id = 'avatars';   -- avatars | t
--   select count(*) from pg_policies where tablename='objects' and policyname like '%avatars%'; -- 4
